# XChain application.
# Created by Rowan Hick - rowan@xchain.ca
# www.xchain.ca
# 
# Licensed according to Mozilla Public License 1.1 as Follows
#
# 1. Definitions.
# 
...
# 
#       The Original Code includes all source (.rb, .rhtml, .rxml, .as, .mxml), image, compiled files contained within the rails 
#       directory structure (application root)
# 
#       The Initial Developer of the Original Code is Rowan Hick.
#       Portions created by
# 
#       Rowan Hick are Copyright (C) 2007
#       _______________________.
#       All Rights
# 
#       Reserved.
# 
#       Contributor(s): ______________ NA _______________.
# 
